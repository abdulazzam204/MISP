...
<script>
    (function () { // variables and functions have their own scope (no override)
        ...
        var countryUrls = {
            'ID': 'misp-galaxy:country="indonesia"|misp-galaxy:region="035 - South-eastern Asia"',
            'JP': 'misp-galaxy:country="japan"',
            'BN': 'misp-galaxy:country="brunei"|misp-galaxy:region="035 - South-eastern Asia"',
            'KH': 'misp-galaxy:country="cambodia"|misp-galaxy:region="035 - South-eastern Asia"',
            'LA': 'misp-galaxy:country="laos"|misp-galaxy:region="035 - South-eastern Asia"',
            'MY': 'misp-galaxy:country="malaysia"|misp-galaxy:region="035 - South-eastern Asia"',
            'MM': 'misp-galaxy:country="myanmar"|misp-galaxy:region="035 - South-eastern Asia"',
            'PH': 'misp-galaxy:country="philippines"|misp-galaxy:region="035 - South-eastern Asia"',
            'SG': 'misp-galaxy:country="singapore"|misp-galaxy:region="035 - South-eastern Asia"',
            'TH': 'misp-galaxy:country="thailand"|misp-galaxy:region="035 - South-eastern Asia"',
            'VN': 'misp-galaxy:country="vietnam"|misp-galaxy:region="035 - South-eastern Asia"',
        };
        ...
        $worldmap.vectorMap({
            ...
            onRegionClick: function (event, code) {
                ...
                if (countryUrls[code]) {
                    window.location.href = '/events/index/searchtags:' + encodeURI(countryUrls[code]);
                } else {
                    alert('No events available for this country.');
                }
            }
        });
